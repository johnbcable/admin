...
If key = "" Or IsNull(key) Then Response.Redirect "Year7andOverlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [Year7andOver] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "Year7andOverlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Year 7and Over<br><br><a href="Year7andOverlist.asp">Back to List</a></span></p>
<p>
<form>
