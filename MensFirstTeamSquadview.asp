...
If key = "" Or IsNull(key) Then Response.Redirect "MensFirstTeamSquadlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [MensFirstTeamSquad] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "MensFirstTeamSquadlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Mens First Team Squad<br><br><a href="MensFirstTeamSquadlist.asp">Back to List</a></span></p>
<p>
<form>
