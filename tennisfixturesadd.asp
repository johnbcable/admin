...
x_pair2 = Request.Form("x_pair2")
		...
		' Open record
		strsql = "SELECT * FROM [tennisfixtures] WHERE 0 = 1"
		Set rs = Server.CreateObject("ADODB.Recordset")
...
<p><span class="aspmaker">Add to TABLE: tennisfixtures<br><br><a href="tennisfixtureslist.asp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="tennisfixturesadd.asp" method="post">
<p>
