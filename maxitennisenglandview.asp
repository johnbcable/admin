...
If key = "" Or IsNull(key) Then Response.Redirect "maxitennisenglandlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [maxitennisengland] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "maxitennisenglandlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: maxitennisengland<br><br><a href="maxitennisenglandlist.asp">Back to List</a></span></p>
<p>
<form>
