...
If key = "" Or IsNull(key) Then Response.Redirect "johnfinchlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [johnfinch] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "johnfinchlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: johnfinch<br><br><a href="johnfinchlist.asp">Back to List</a></span></p>
<p>
<form>
