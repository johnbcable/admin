...
If key = "" Or IsNull(key) Then Response.Redirect "AdultFemaleMemberslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [AdultFemaleMembers] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "AdultFemaleMemberslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Adult Female Members<br><br><a href="AdultFemaleMemberslist.asp">Back to List</a></span></p>
<p>
<form>
