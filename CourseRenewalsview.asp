...
If key = "" Or IsNull(key) Then Response.Redirect "CourseRenewalslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [CourseRenewals] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "CourseRenewalslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Course Renewals<br><br><a href="CourseRenewalslist.asp">Back to List</a></span></p>
<p>
<form>
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	...
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="aspmaker"><% Response.Write x_dob %></span>&nbsp;</td>
	</tr>
	<tr>
