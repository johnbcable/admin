...
If key = "" Or IsNull(key) Then Response.Redirect "CourseOnlylist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [CourseOnly] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "CourseOnlylist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Course Only<br><br><a href="CourseOnlylist.asp">Back to List</a></span></p>
<p>
<form>
