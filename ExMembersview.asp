...
If key = "" Or IsNull(key) Then Response.Redirect "ExMemberslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [ExMembers] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "ExMemberslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Ex Members<br><br><a href="ExMemberslist.asp">Back to List</a></span></p>
<p>
<form>
