...
If key = "" Or IsNull(key) Then Response.Redirect "MensSecondTeamSquadlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [MensSecondTeamSquad] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "MensSecondTeamSquadlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Mens Second Team Squad<br><br><a href="MensSecondTeamSquadlist.asp">Back to List</a></span></p>
<p>
<form>
