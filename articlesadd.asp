...
x_articlesection = Request.Form("x_articlesection")
		...
		' Open record
		strsql = "SELECT * FROM [articles] WHERE 0 = 1"
		Set rs = Server.CreateObject("ADODB.Recordset")
...
<p><span class="aspmaker">Add to TABLE: articles<br><br><a href="articleslist.asp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="articlesadd.asp" method="post">
<p>
