...
If key = "" Or IsNull(key) Then Response.Redirect "AdultMaleMemberslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [AdultMaleMembers] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "AdultMaleMemberslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Adult Male Members<br><br><a href="AdultMaleMemberslist.asp">Back to List</a></span></p>
<p>
<form>
