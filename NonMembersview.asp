...
If key = "" Or IsNull(key) Then Response.Redirect "NonMemberslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [NonMembers] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "NonMemberslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Non Members<br><br><a href="NonMemberslist.asp">Back to List</a></span></p>
<p>
<form>
