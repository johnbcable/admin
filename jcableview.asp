...
If key = "" Or IsNull(key) Then Response.Redirect "jcablelist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [jcable] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "jcablelist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: jcable<br><br><a href="jcablelist.asp">Back to List</a></span></p>
<p>
<form>
