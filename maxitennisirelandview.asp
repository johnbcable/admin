...
If key = "" Or IsNull(key) Then Response.Redirect "maxitennisirelandlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [maxitennisireland] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "maxitennisirelandlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: maxitennisireland<br><br><a href="maxitennisirelandlist.asp">Back to List</a></span></p>
<p>
<form>
