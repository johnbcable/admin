...
If key = "" Or IsNull(key) Then Response.Redirect "LadiesFirstTeamSquadlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [LadiesFirstTeamSquad] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "LadiesFirstTeamSquadlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Ladies First Team Squad<br><br><a href="LadiesFirstTeamSquadlist.asp">Back to List</a></span></p>
<p>
<form>
