...
If key = "" Or IsNull(key) Then Response.Redirect "LadiesSecondTeamSquadlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [LadiesSecondTeamSquad] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "LadiesSecondTeamSquadlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Ladies Second Team Squad<br><br><a href="LadiesSecondTeamSquadlist.asp">Back to List</a></span></p>
<p>
<form>
