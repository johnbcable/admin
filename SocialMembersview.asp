...
If key = "" Or IsNull(key) Then Response.Redirect "SocialMemberslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [SocialMembers] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "SocialMemberslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Social Members<br><br><a href="SocialMemberslist.asp">Back to List</a></span></p>
<p>
<form>
