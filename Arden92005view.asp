...
If key = "" Or IsNull(key) Then Response.Redirect "Arden92005list.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [Arden92005] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "Arden92005list.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Arden 92005<br><br><a href="Arden92005list.asp">Back to List</a></span></p>
<p>
<form>
