...
If key = "" Or IsNull(key) Then Response.Redirect "maxicaptainslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [maxicaptains] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "maxicaptainslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: maxicaptains<br><br><a href="maxicaptainslist.asp">Back to List</a></span></p>
<p>
<form>
