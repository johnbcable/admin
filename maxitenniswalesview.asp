...
If key = "" Or IsNull(key) Then Response.Redirect "maxitenniswaleslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [maxitenniswales] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "maxitenniswaleslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: maxitenniswales<br><br><a href="maxitenniswaleslist.asp">Back to List</a></span></p>
<p>
<form>
