...
x_comments = Request.Form("x_comments")
		...
		' Open record
		strsql = "SELECT * FROM [otherclubs] WHERE 0 = 1"
		Set rs = Server.CreateObject("ADODB.Recordset")
...
<p><span class="aspmaker">Add to TABLE: otherclubs<br><br><a href="otherclubslist.asp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="otherclubsadd.asp" method="post">
<p>
