...
If key = "" Or IsNull(key) Then Response.Redirect "arden9runnerslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [arden9runners] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "arden9runnerslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View TABLE: arden 9runners<br><br><a href="arden9runnerslist.asp">Back to List</a></span></p>
<p>
<form>
