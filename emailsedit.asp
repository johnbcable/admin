...
<p><span class="aspmaker">Edit TABLE: emails<br><br><a href="emailslist.asp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="emailsedit" action="emailsedit.asp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="aspmaker"><% Response.Write x_emailid %><input type="hidden" name="x_emailid" value="<%= x_emailid %>"></span>&nbsp;</td>
	</tr>
	<tr>
