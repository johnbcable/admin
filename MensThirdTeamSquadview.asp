...
If key = "" Or IsNull(key) Then Response.Redirect "MensThirdTeamSquadlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [MensThirdTeamSquad] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "MensThirdTeamSquadlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Mens Third Team Squad<br><br><a href="MensThirdTeamSquadlist.asp">Back to List</a></span></p>
<p>
<form>
