...
<p><span class="aspmaker">Edit TABLE: members<br><br><a href="memberslist.asp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="membersedit" action="membersedit.asp" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	...
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="aspmaker"><% Response.Write x_uniqueref %><input type="hidden" name="x_uniqueref" value="<%= x_uniqueref %>"></span>&nbsp;</td>
	</tr>
	<tr>
