...
If key = "" Or IsNull(key) Then Response.Redirect "maxitennisitalylist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [maxitennisitaly] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "maxitennisitalylist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: maxitennisitaly<br><br><a href="maxitennisitalylist.asp">Back to List</a></span></p>
<p>
<form>
