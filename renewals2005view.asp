...
If key = "" Or IsNull(key) Then Response.Redirect "renewals2005list.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [renewals2005] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "renewals2005list.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: renewals 2005<br><br><a href="renewals2005list.asp">Back to List</a></span></p>
<p>
<form>
