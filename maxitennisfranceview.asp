...
If key = "" Or IsNull(key) Then Response.Redirect "maxitennisfrancelist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [maxitennisfrance] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "maxitennisfrancelist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: maxitennisfrance<br><br><a href="maxitennisfrancelist.asp">Back to List</a></span></p>
<p>
<form>
