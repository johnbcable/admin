...
If key = "" Or IsNull(key) Then Response.Redirect "teamcaptainslist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [teamcaptains] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "teamcaptainslist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: teamcaptains<br><br><a href="teamcaptainslist.asp">Back to List</a></span></p>
<p>
<form>
