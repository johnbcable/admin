...
If searchwhere <> "" Then
	Session("JuniorMembers_searchwhere") = searchwhere

	' Reset start record counter (new search)
	startRec = 1
	Session("JuniorMembers_REC") = startRec
Else
	searchwhere = Session("JuniorMembers_searchwhere")
End If
%>
<%
...
If Request.QueryString("order").Count > 0 Then
	...
	If Session("JuniorMembers_OB") = OrderBy Then
		If Session("JuniorMembers_OT") = "ASC" Then
			Session("JuniorMembers_OT") = "DESC"
		Else
			Session("JuniorMembers_OT") = "ASC"
		End if
	Else
		Session("JuniorMembers_OT") = "ASC"
	End If
	Session("JuniorMembers_OB") = OrderBy
	Session("JuniorMembers_REC") = 1
Else
	OrderBy = Session("JuniorMembers_OB")
	If OrderBy = "" Then
		OrderBy = DefaultOrder
		Session("JuniorMembers_OB") = OrderBy
		Session("JuniorMembers_OT") = DefaultOrderType
	End If
End If
...
' Build SQL
strsql = "SELECT * FROM [JuniorMembers]"
...
End If
If OrderBy <> "" Then 
	strsql = strsql & " ORDER BY [" & OrderBy & "] " & Session("JuniorMembers_OT")
End If	
...
ElseIf Request.QueryString("pageno").Count > 0 Then
	...
	If IsNumeric(pageno) Then
		...
		Session("JuniorMembers_REC") = startRec
	Else
		startRec = Session("JuniorMembers_REC")
...
<p><span class="aspmaker">VIEW: Junior Members</span></p>
<form action="JuniorMemberslist.asp">
<table border="0" cellspacing="0" cellpadding="4">
	<tr>
		...
		&nbsp;&nbsp;<a href="JuniorMemberslist.asp?cmd=reset">Show all</a>
		</span></td>
	</tr>
...
<a href="JuniorMemberslist.asp?order=<%= Server.URLEncode("surname") %>" style="color: #FFFFFF;">surname&nbsp;(*)<% If OrderBy = "surname" Then %><span class="ewTableOrderIndicator"><% If Session("JuniorMembers_OT") = "ASC" Then %>5<% ElseIf Session("JuniorMembers_OT") = "DESC" Then %>6<% End If %></span><% End If %></a>
		</span></td>
		<td><span class="aspmaker" style="color: #FFFFFF;">
<a href="JuniorMemberslist.asp?order=<%= Server.URLEncode("forename1") %>" style="color: #FFFFFF;">forename 1&nbsp;(*)<% If OrderBy = "forename1" Then %><span class="ewTableOrderIndicator"><% If Session("JuniorMembers_OT") = "ASC" Then %>5<% ElseIf Session("JuniorMembers_OT") = "DESC" Then %>6<% End If %></span><% End If %></a>
		</span></td>
		<td><span class="aspmaker" style="color: #FFFFFF;">
<a href="JuniorMemberslist.asp?order=<%= Server.URLEncode("email") %>" style="color: #FFFFFF;">email&nbsp;(*)<% If OrderBy = "email" Then %><span class="ewTableOrderIndicator"><% If Session("JuniorMembers_OT") = "ASC" Then %>5<% ElseIf Session("JuniorMembers_OT") = "DESC" Then %>6<% End If %></span><% End If %></a>
		</span></td>
		<td><span class="aspmaker" style="color: #FFFFFF;">
<a href="JuniorMemberslist.asp?order=<%= Server.URLEncode("dob") %>" style="color: #FFFFFF;">dob&nbsp;<% If OrderBy = "dob" Then %><span class="ewTableOrderIndicator"><% If Session("JuniorMembers_OT") = "ASC" Then %>5<% ElseIf Session("JuniorMembers_OT") = "DESC" Then %>6<% End If %></span><% End If %></a>
		</span></td>
		<td><span class="aspmaker" style="color: #FFFFFF;">
<a href="JuniorMemberslist.asp?order=<%= Server.URLEncode("membergrade") %>" style="color: #FFFFFF;">membergrade&nbsp;(*)<% If OrderBy = "membergrade" Then %><span class="ewTableOrderIndicator"><% If Session("JuniorMembers_OT") = "ASC" Then %>5<% ElseIf Session("JuniorMembers_OT") = "DESC" Then %>6<% End If %></span><% End If %></a>
		</span></td>
</tr>
<%
...
<!--first page button-->
	...
	<% Else %>
	<td><a href="JuniorMemberslist.asp?start=1"><img src="images/first.gif" alt="First" width="20" height="15" border="0"></a></td>
	<% End If %>
<!--previous page button-->
	<% If CLng(PrevStart) = CLng(startRec) Then %>
	<td><img src="images/prevdisab.gif" alt="Previous" width="20" height="15" border="0"></td>
	<% Else %>
	<td><a href="JuniorMemberslist.asp?start=<%=PrevStart%>"><img src="images/prev.gif" alt="Previous" width="20" height="15" border="0"></a></td>
	<% End If %>
<!--current page number-->
...
<!--next page button-->
	...
	<% Else %>
	<td><a href="JuniorMemberslist.asp?start=<%=NextStart%>"><img src="images/next.gif" alt="Next" width="20" height="15" border="0"></a></td>
	<% End If %>
<!--last page button-->
	<% If CLng(LastStart) = CLng(startRec) Then %>
	<td><img src="images/lastdisab.gif" alt="Last" width="20" height="15" border="0"></td>
	<% Else %>
	<td><a href="JuniorMemberslist.asp?start=<%=LastStart%>"><img src="images/last.gif" alt="Last" width="20" height="15" border="0"></a></td>
	<% End If %>
