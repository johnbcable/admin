...
If key = "" Or IsNull(key) Then Response.Redirect "maxitennisscotlandlist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [maxitennisscotland] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "maxitennisscotlandlist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: maxitennisscotland<br><br><a href="maxitennisscotlandlist.asp">Back to List</a></span></p>
<p>
<form>
