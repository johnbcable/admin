...
x_eventreport = Request.Form("x_eventreport")
		...
		' Open record
		strsql = "SELECT * FROM [events] WHERE 0 = 1"
		Set rs = Server.CreateObject("ADODB.Recordset")
...
<p><span class="aspmaker">Add to TABLE: events<br><br><a href="eventslist.asp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="eventsadd.asp" method="post">
<p>
