...
If key = "" Or IsNull(key) Then Response.Redirect "Under7slist.asp"
...
Select Case a
	Case "I": ' Get a record to display
		tkey = "" & key & ""
		strsql = "SELECT * FROM [Under7s] WHERE []=" & tkey
		Set rs = Server.CreateObject("ADODB.Recordset")
		rs.Open strsql, conn
		If rs.Eof Then
			Response.Clear
			Response.Redirect "Under7slist.asp"
		Else
			rs.MoveFirst
		End If
...
<p><span class="aspmaker">View VIEW: Under 7s<br><br><a href="Under7slist.asp">Back to List</a></span></p>
<p>
<form>
