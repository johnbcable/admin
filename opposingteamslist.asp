...
If searchwhere <> "" Then
	Session("opposingteams_searchwhere") = searchwhere

	' Reset start record counter (new search)
	startRec = 1
	Session("opposingteams_REC") = startRec
Else
	searchwhere = Session("opposingteams_searchwhere")
End If
%>
<%
...
If Request.QueryString("order").Count > 0 Then
	...
	If Session("opposingteams_OB") = OrderBy Then
		If Session("opposingteams_OT") = "ASC" Then
			Session("opposingteams_OT") = "DESC"
		Else
			Session("opposingteams_OT") = "ASC"
		End if
	Else
		Session("opposingteams_OT") = "ASC"
	End If
	Session("opposingteams_OB") = OrderBy
	Session("opposingteams_REC") = 1
Else
	OrderBy = Session("opposingteams_OB")
	If OrderBy = "" Then
		OrderBy = DefaultOrder
		Session("opposingteams_OB") = OrderBy
		Session("opposingteams_OT") = DefaultOrderType
	End If
End If
...
' Build SQL
strsql = "SELECT * FROM [opposingteams]"
...
End If
If OrderBy <> "" Then 
	strsql = strsql & " ORDER BY [" & OrderBy & "] " & Session("opposingteams_OT")
End If	
...
ElseIf Request.QueryString("pageno").Count > 0 Then
	...
	If IsNumeric(pageno) Then
		...
		Session("opposingteams_REC") = startRec
	Else
		startRec = Session("opposingteams_REC")
...
<p><span class="aspmaker">VIEW: opposingteams</span></p>
<form action="opposingteamslist.asp">
<table border="0" cellspacing="0" cellpadding="4">
	<tr>
		...
		&nbsp;&nbsp;<a href="opposingteamslist.asp?cmd=reset">Show all</a>
		</span></td>
	</tr>
...
<a href="opposingteamslist.asp?order=<%= Server.URLEncode("opponents") %>" style="color: #FFFFFF;">opponents&nbsp;(*)<% If OrderBy = "opponents" Then %><span class="ewTableOrderIndicator"><% If Session("opposingteams_OT") = "ASC" Then %>5<% ElseIf Session("opposingteams_OT") = "DESC" Then %>6<% End If %></span><% End If %></a>
		</span></td>
</tr>
<%
...
<!--first page button-->
	...
	<% Else %>
	<td><a href="opposingteamslist.asp?start=1"><img src="images/first.gif" alt="First" width="20" height="15" border="0"></a></td>
	<% End If %>
<!--previous page button-->
	<% If CLng(PrevStart) = CLng(startRec) Then %>
	<td><img src="images/prevdisab.gif" alt="Previous" width="20" height="15" border="0"></td>
	<% Else %>
	<td><a href="opposingteamslist.asp?start=<%=PrevStart%>"><img src="images/prev.gif" alt="Previous" width="20" height="15" border="0"></a></td>
	<% End If %>
<!--current page number-->
...
<!--next page button-->
	...
	<% Else %>
	<td><a href="opposingteamslist.asp?start=<%=NextStart%>"><img src="images/next.gif" alt="Next" width="20" height="15" border="0"></a></td>
	<% End If %>
<!--last page button-->
	<% If CLng(LastStart) = CLng(startRec) Then %>
	<td><img src="images/lastdisab.gif" alt="Last" width="20" height="15" border="0"></td>
	<% Else %>
	<td><a href="opposingteamslist.asp?start=<%=LastStart%>"><img src="images/last.gif" alt="Last" width="20" height="15" border="0"></a></td>
	<% End If %>
